    ...
    $(options.videos).each(function loopingItems()
    {
        ...
        switch(self.options.playlist){
            case "Right playlist":
                ...
                {
					$(self.item_array[self.videoid]).removeClass("elite_vp_itemUnselected"+" "+this.options.instanceTheme).addClass("elite_vp_itemSelected"+" "+this.options.instanceTheme);//first selected
            ...
            case "Bottom playlist":
				if(options.loadRandomVideoOnStart=="Yes")
                {
					$(self.item_array[self.rand]).removeClass("elite_vp_itemUnselected_bottom"+" "+this.options.instanceTheme).addClass("elite_vp_itemSelected_bottom"+" "+this.options.instanceTheme);//first selected
					self.item_array[self.rand].find(".elite_vp_thumbnail_image").removeClass("elite_vp_thumbnail_image").addClass("elite_vp_thumbnail_imageSelected");// selected
					self.VIDEO.playedVideos.push(self.rand)
				}
				else
                {
					$(self.item_array[self.videoid]).removeClass("elite_vp_itemUnselected_bottom"+" "+this.options.instanceTheme).addClass("elite_vp_itemSelected_bottom"+" "+this.options.instanceTheme);//first selected
					self.item_array[self.videoid].find(".elite_vp_thumbnail_image").removeClass("elite_vp_thumbnail_image").addClass("elite_vp_thumbnail_imageSelected");// selected
					self.VIDEO.playedVideos.push(self.videoid)
                }
                break;
