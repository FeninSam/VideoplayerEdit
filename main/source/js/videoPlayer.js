...
Video.fn.setColorAccent = function(colorAccent,colorTransparent, btn){
	var self=this;
	$('.elite_vp_themeColor').css({"background":colorAccent});
	$('.elite_vp_themeColorText').css({"color":colorAccent});
	$('.elite_vp_playBtnBg').css({"background":colorTransparent});
	if($(btn).hasClass('fa-elite-random'))
	{
		...
		$("#elite_vp_shuffleBtn.elite_vp_playBtnBg").css({"background":colorTransparent});
	}
	if($(btn).hasClass('fa-elite-cog'))
	{
		...
		$("#elite_vp_qualityBtn.elite_vp_playBtnBg").css({"background":colorTransparent});
	}
};
...
Video.fn.createEmbedWindowContent = function()
{
    ...
    $(this.embedWindow).find("#elite_vp_copy").append('<p id="elite_vp_copyInside" class="elite_vp_copyInside'+" "+this.options.instanceTheme+'">' + self.options.copyTxt + '</p>');
    ...
    $(this.embedWindow).find("#elite_vp_copy2").append('<p id="elite_vp_copyInside" class="elite_vp_copyInside'+" "+this.options.instanceTheme+'">' + self.options.copyTxt + '</p>');
...
Video.fn.toggleShuffleBtn = function()
{
    ...
    else
    {
		...
		this.setColorAccent(this.options.colorAccent,this.options.colorTransparent, $("#elite_vp_shuffleBtn"));
    }
};
Video.fn.toggleQualityBtn = function()
{
    ...
    else
    {
		...
		this.setColorAccent(this.options.colorAccent,this.options.colorTransparent, $("#elite_vp_qualityBtn"));
    }
};
  ...
  var self = this;
	...
	if(isMobile.iOS() && this.options.autoplay && (this._playlist.videos_array[this._playlist.videoid].videoType=="HTML5" || this.options.videoType=="HTML5 (self-hosted)")){
		...
		this.iOSVolumeButtonScreen.addClass("elite_vp_iOSVolumeButtonScreen")
		  .attr("aria-hidden","true")
		  .addClass("fa-elite")
		  .addClass("fa-elite-iOSBtnScreen"+" "+this.options.instanceTheme).addClass("pulse")
...
Video.fn.setupElements = function(){
	...
	$('.elite_vp_playBtnBg').css({"background":this.options.colorTransparent});
}
